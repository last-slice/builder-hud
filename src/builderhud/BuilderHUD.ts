...
class BuilderHUD {
    ...
    constructor () {
        ...
        this.leftWall.addComponent(new BasicMaterial())
        this.leftWall.getComponent(BasicMaterial).texture = this.transparent
        ...
        this.rightWall.addComponent(new BasicMaterial())
        this.rightWall.getComponent(BasicMaterial).texture = this.transparent
        ...
        this.frontWall.addComponent(new BasicMaterial())
        this.frontWall.getComponent(BasicMaterial).texture = this.transparent
        ...
        this.backWall.addComponent(new BasicMaterial())
        this.backWall.getComponent(BasicMaterial).texture = this.transparent
